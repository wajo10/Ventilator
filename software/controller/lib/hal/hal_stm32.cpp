...
static Debug::Variable::Primitive32 dbg_loop_latency("loop_latency", DebugFB::VarAccess::ReadOnly,
                                                     &latency, "\xB5s", "Latency of loop function",
                                                     "%.2f");
static Debug::Variable::Primitive32 dbg_max_latency("max_latency", DebugFB::VarAccess::ReadOnly,
                                                    &max_latency, "\xB5s",
                                                    "Maximum latency of loop function", "%.2f");
static Debug::Variable::Primitive32 dbg_loop_time("loop_time", DebugFB::VarAccess::ReadOnly,
