...
public:
  ...
  bool Handler(Time current_timestamp, Time lastrx_timestamp);
  bool CommunicationFailed(Time occurrence_timestamp);
  bool CommunicationResumed(Time occurrence_timestamp);
