...
static Debug::Variable::UInt32 dbg_reinit(
    "nvparams_reinit", DebugFB::VarAccess::ReadWrite, 0, "",
    "Set to 1 to request a reinit of NV params on next boot.");

static Debug::Variable::UInt32 dbg_serial("serial_number", DebugFB::VarAccess::ReadWrite, 0, "",
                                          "Serial number of the ventilator, in EEPROM");

static Debug::Variable::UInt32 dbg_nvparams("nvparams_address", DebugFB::VarAccess::ReadOnly, 0, "",
