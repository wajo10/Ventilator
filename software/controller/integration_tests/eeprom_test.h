...
static Debug::Variable::UInt32 dbg_addr_before("eeprom_before", DebugFB::VarAccess::ReadOnly, 0, "",
                                               "address of eeprom contents at startup");
static Debug::Variable::UInt32 dbg_write_data("write_data", DebugFB::VarAccess::ReadOnly, 0, "",
                                              "address of write data");
static Debug::Variable::UInt32 dbg_addr_after("eeprom_after", DebugFB::VarAccess::ReadOnly, 0, "",
                                              "address of eeprom contents after write");
static Debug::Variable::UInt32 dbg_test_result("result", DebugFB::VarAccess::ReadOnly, 0, "",
                                               "result of the test");
