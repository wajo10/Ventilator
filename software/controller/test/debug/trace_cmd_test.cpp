...
TEST(TraceHandler, Flush) {
  ...
  Debug::Variable::FnVar var_x(
      DebugFB::VarType::UInt32, "x", DebugFB::VarAccess::ReadOnly, "unit", [&] { return i; },
      [&](uint32_t value) { (void)value; }, "");
  Debug::Variable::FnVar var_y(
      DebugFB::VarType::UInt32, "x", DebugFB::VarAccess::ReadOnly, "unit", [&] { return i * 10; },
      [&](uint32_t value) { (void)value; }, "");
...
TEST(TraceHandler, Read) {
  ...
  Debug::Variable::FnVar var_x(
      ...
      [&](uint32_t value) { (void)value; }, "");
  Debug::Variable::FnVar var_y(
      DebugFB::VarType::UInt32, "y", DebugFB::VarAccess::ReadOnly, "unit", [&] { return i * 10; },
      [&](uint32_t value) { (void)value; }, "");
...
TEST(TraceHandler, SettersAndGetters) {
  ...
  Debug::Variable::UInt32 var_x("x", DebugFB::VarAccess::ReadOnly, 0, "unit");
  Debug::Variable::UInt32 var_y("y", DebugFB::VarAccess::ReadOnly, 0, "unit");
