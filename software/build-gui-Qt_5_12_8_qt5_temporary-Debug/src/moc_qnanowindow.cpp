...
#include "../../gui/src/third_party/qnanopainter/libqnanopainter/qnanowindow.h"
...
void QNanoWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QNanoWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QNanoWindow::*)(QTouchEvent * );
        ...
        {
            using _t = void (QNanoWindow::*)(QNanoPainter * );
...
QT_INIT_METAOBJECT const QMetaObject QNanoWindow::staticMetaObject = { {
    &QOpenGLWindow::staticMetaObject,
    qt_meta_stringdata_QNanoWindow.data,
    qt_meta_data_QNanoWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
