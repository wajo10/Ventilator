...
#ifndef FLATBUFFERS_GENERATED_DEBUGFLATBUF_DEBUGFB_H_
#define FLATBUFFERS_GENERATED_DEBUGFLATBUF_DEBUGFB_H_
...
inline const CmdCode (&EnumValuesCmdCode())[7] {
  static const CmdCode values[] = {CmdCode::Mode,        CmdCode::Peek,     CmdCode::Poke,
                                   CmdCode::Console,     CmdCode::Variable, CmdCode::Trace,
                                   CmdCode::EepromAccess};
  return values;
}

inline const char *const *EnumNamesCmdCode() {
  static const char *const names[] = {"Mode",     "Peek",  "Poke",         "Console",
                                      "Variable", "Trace", "EepromAccess", nullptr};
  return names;
}
...
inline const VarSubcmd (&EnumValuesVarSubcmd())[4] {
  static const VarSubcmd values[] = {VarSubcmd::GetInfo, VarSubcmd::Get, VarSubcmd::Set,
                                     VarSubcmd::GetCount};
  return values;
}

inline const char *const *EnumNamesVarSubcmd() {
  static const char *const names[] = {"GetInfo", "Get", "Set", "GetCount", nullptr};
  return names;
}
...
enum class VarType : int8_t { Int32 = 0, UInt32 = 1, Float = 2, MIN = Int32, MAX = Float };

inline const VarType (&EnumValuesVarType())[3] {
  static const VarType values[] = {VarType::Int32, VarType::UInt32, VarType::Float};
  return values;
}

inline const char *const *EnumNamesVarType() {
  static const char *const names[] = {"Int32", "UInt32", "Float", nullptr};
  return names;
}

inline const char *EnumNameVarType(VarType e) {
  if (e < VarType::Int32 || e > VarType::Float) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesVarType()[index];
}

enum class VarAccess : int8_t { ReadOnly = 0, ReadWrite = 1, MIN = ReadOnly, MAX = ReadWrite };
...
inline const char *EnumNameVarAccess(VarAccess e) {
  if (e < VarAccess::ReadOnly || e > VarAccess::ReadWrite) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesVarAccess()[index];
}

enum class CmdData : uint8_t { NONE = 0, VarAccessData = 1, MIN = NONE, MAX = VarAccessData };
...
inline const char *EnumNameCmdData(CmdData e) {
  if (e < CmdData::NONE || e > CmdData::VarAccessData) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesCmdData()[index];
}

template <typename T>
struct CmdDataTraits {
  static const CmdData enum_value = CmdData::NONE;
};

template <>
struct CmdDataTraits<VarAccessData> {
  static const CmdData enum_value = CmdData::VarAccessData;
};

bool VerifyCmdData(flatbuffers::Verifier &verifier, const void *obj, CmdData type);
bool VerifyCmdDataVector(flatbuffers::Verifier &verifier,
...
inline const char *const *EnumNamesErrorCode() {
  static const char *const names[] = {"None",     "CrcError",      "UnknownCommand",  "MissingData",
...
inline const char *EnumNameErrorCode(ErrorCode e) {
  if (e < ErrorCode::None || e > ErrorCode::Timeout) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const ResponseData (&EnumValuesResponseData())[5] {
  static const ResponseData values[] = {ResponseData::NONE, ResponseData::Int, ResponseData::UInt,
                                        ResponseData::Float, ResponseData::GetVarInfoResponse};
  return values;
}

inline const char *const *EnumNamesResponseData() {
  static const char *const names[] = {"NONE", "Int", "UInt", "Float", "GetVarInfoResponse",
                                      nullptr};
  return names;
}

inline const char *EnumNameResponseData(ResponseData e) {
  if (e < ResponseData::NONE || e > ResponseData::GetVarInfoResponse) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesResponseData()[index];
}

template <typename T>
struct ResponseDataTraits {
  static const ResponseData enum_value = ResponseData::NONE;
};

template <>
struct ResponseDataTraits<Int> {
  static const ResponseData enum_value = ResponseData::Int;
};

template <>
struct ResponseDataTraits<UInt> {
  static const ResponseData enum_value = ResponseData::UInt;
};

template <>
struct ResponseDataTraits<Float> {
  static const ResponseData enum_value = ResponseData::Float;
};

template <>
struct ResponseDataTraits<GetVarInfoResponse> {
...
bool VerifyResponseDataVector(flatbuffers::Verifier &verifier,
                              const flatbuffers::Vector<flatbuffers::Offset<void>> *values,
                              const flatbuffers::Vector<uint8_t> *types);
...
struct Int FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, VT_VAL) &&
           verifier.EndTable();
  }
};
...
struct UInt FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyField<uint32_t>(verifier, VT_VAL) &&
           verifier.EndTable();
  }
};
...
struct UIntBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_val(uint32_t val) { fbb_.AddElement<uint32_t>(UInt::VT_VAL, val, 0); }
...
struct VarAccessData FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  VarSubcmd subcmd() const { return static_cast<VarSubcmd>(GetField<int8_t>(VT_SUBCMD, 0)); }
  uint16_t vid() const { return GetField<uint16_t>(VT_VID, 65535); }
  uint32_t val() const { return GetField<uint32_t>(VT_VAL, 4294967295); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyField<int8_t>(verifier, VT_SUBCMD) &&
           VerifyField<uint16_t>(verifier, VT_VID) && VerifyField<uint32_t>(verifier, VT_VAL) &&
           verifier.EndTable();
  }
};
...
struct VarAccessDataBuilder {
  ...
  void add_subcmd(VarSubcmd subcmd) {
    fbb_.AddElement<int8_t>(VarAccessData::VT_SUBCMD, static_cast<int8_t>(subcmd), 0);
  }
  void add_vid(uint16_t vid) { fbb_.AddElement<uint16_t>(VarAccessData::VT_VID, vid, 65535); }
  void add_val(uint32_t val) { fbb_.AddElement<uint32_t>(VarAccessData::VT_VAL, val, 4294967295); }
  explicit VarAccessDataBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<VarAccessData> CreateVarAccessData(flatbuffers::FlatBufferBuilder &_fbb,
...
struct Request FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  CmdCode cmd() const { return static_cast<CmdCode>(GetField<int8_t>(VT_CMD, 0)); }
  ...
  template <typename T>
  const T *cmddata_as() const;
  const VarAccessData *cmddata_as_VarAccessData() const {
    return cmddata_type() == CmdData::VarAccessData ? static_cast<const VarAccessData *>(cmddata())
                                                    : nullptr;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyField<int8_t>(verifier, VT_CMD) &&
           VerifyField<uint8_t>(verifier, VT_CMDDATA_TYPE) && VerifyOffset(verifier, VT_CMDDATA) &&
           VerifyCmdData(verifier, cmddata(), cmddata_type()) && verifier.EndTable();
  }
};
...
struct RequestBuilder {
  ...
  void add_cmddata_type(CmdData cmddata_type) {
    fbb_.AddElement<uint8_t>(Request::VT_CMDDATA_TYPE, static_cast<uint8_t>(cmddata_type), 0);
  }
...
struct GetVarInfoResponse FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  VarAccess access() const { return static_cast<VarAccess>(GetField<int8_t>(VT_ACCESS, 0)); }
  const flatbuffers::String *name() const {
    return GetPointer<const flatbuffers::String *>(VT_NAME);
  }
  const flatbuffers::String *fmt() const { return GetPointer<const flatbuffers::String *>(VT_FMT); }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyField<int8_t>(verifier, VT_TYPE) &&
           VerifyField<int8_t>(verifier, VT_ACCESS) && VerifyOffset(verifier, VT_NAME) &&
           verifier.VerifyString(name()) && VerifyOffset(verifier, VT_FMT) &&
           verifier.VerifyString(fmt()) && VerifyOffset(verifier, VT_HELP) &&
           verifier.VerifyString(help()) && VerifyOffset(verifier, VT_UNIT) &&
           verifier.VerifyString(unit()) && verifier.EndTable();
  }
};
...
struct GetVarInfoResponseBuilder {
  ...
  void add_type(VarType type) {
    fbb_.AddElement<int8_t>(GetVarInfoResponse::VT_TYPE, static_cast<int8_t>(type), 0);
  }
  void add_access(VarAccess access) {
    fbb_.AddElement<int8_t>(GetVarInfoResponse::VT_ACCESS, static_cast<int8_t>(access), 0);
  }
  ...
  explicit GetVarInfoResponseBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<GetVarInfoResponse> CreateGetVarInfoResponse(
    flatbuffers::FlatBufferBuilder &_fbb, VarType type = VarType::Int32,
    VarAccess access = VarAccess::ReadOnly, flatbuffers::Offset<flatbuffers::String> name = 0,
...
inline flatbuffers::Offset<GetVarInfoResponse> CreateGetVarInfoResponseDirect(
    flatbuffers::FlatBufferBuilder &_fbb, VarType type = VarType::Int32,
    VarAccess access = VarAccess::ReadOnly, const char *name = nullptr, const char *fmt = nullptr,
  ...
  return DebugFB::CreateGetVarInfoResponse(_fbb, type, access, name__, fmt__, help__, unit__);
}

inline bool VerifyCmdData(flatbuffers::Verifier &verifier, const void *obj, CmdData type) {
  switch (type) {
    case CmdData::NONE: {
      return true;
    }
...
inline bool VerifyCmdDataVector(flatbuffers::Verifier &verifier,
                                const flatbuffers::Vector<flatbuffers::Offset<void>> *values,
                                const flatbuffers::Vector<uint8_t> *types) {
...
inline bool VerifyResponseDataVector(flatbuffers::Verifier &verifier,
                                     const flatbuffers::Vector<flatbuffers::Offset<void>> *values,
                                     const flatbuffers::Vector<uint8_t> *types) {
  if (!values || !types) return !values && !types;
  if (values->size() != types->size()) return false;
  for (flatbuffers::uoffset_t i = 0; i < values->size(); ++i) {
    if (!VerifyResponseData(verifier, values->Get(i), types->GetEnum<ResponseData>(i))) {
      return false;
    }
  }
  return true;
...
#endif  // FLATBUFFERS_GENERATED_DEBUGFLATBUF_DEBUGFB_H_
