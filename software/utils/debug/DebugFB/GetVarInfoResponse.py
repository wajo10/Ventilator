...
def GetVarInfoResponseAddFmt(builder, fmt):
    builder.PrependUOffsetTRelativeSlot(
        3, flatbuffers.number_types.UOffsetTFlags.py_type(fmt), 0
    )


def GetVarInfoResponseAddHelp(builder, help):
    builder.PrependUOffsetTRelativeSlot(
        4, flatbuffers.number_types.UOffsetTFlags.py_type(help), 0
    )


def GetVarInfoResponseAddUnit(builder, unit):
    builder.PrependUOffsetTRelativeSlot(
        5, flatbuffers.number_types.UOffsetTFlags.py_type(unit), 0
    )
